#for Big-O operation using timeit library
import timeit
...
#Big-O using the timeit library  is more precise than time library as it neglacts the
#variability of the system by repeating the program several times

elapsed_time = timeit.timeit(code_to_time, number=100000)
