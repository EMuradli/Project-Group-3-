...
ListOfElements = []
MatrixOfElements = []
print("Input your unbalanced reactants. This is case sensitive.")
print("As an example, here is what your input should look like: P4O10 + H2O")
reactants = input("Reactants: ")
print("Input your unbalanced products. This is case sensitive.")
print('As another example, here is what your input should look like: H3PO4')
