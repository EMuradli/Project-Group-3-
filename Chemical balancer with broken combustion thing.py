...
def carbon_hydrogen_oxygen():
    elementsKeys = list(elementsParse.keys())
    print(elementsKeys)

    for i in range(len(elementsKeys)):
        if elementsKeys[i] == 'C':
            cVal = list(elementsParse.values())
            c = cVal[i]
            print(c)
            return c
        if elementsKeys[i] == 'H':
            hVal = list(elementsParse.values())
            h = hVal[i]
            print(h)
            return h
        if elementsKeys[i] == 'O':
            oVal = list(elementsParse.values())
            o = oVal[i]
            print(o)
            return o
...
def combustion_reaction():
    ...
    if ratioOC == 1:
        print('Complete combustion')
    elif ratioOC < 1:
        print('Incomplete combustion')
    else:
        print('Not a combustion reaction')


gaussian_elimination()
free_variable()
carbon_hydrogen_oxygen()
combustion_reaction()